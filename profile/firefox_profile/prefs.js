...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1759763688);
user_pref("app.update.lastUpdateTime.background-update-timer", 1759763688);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1759841910);
user_pref("app.update.lastUpdateTime.region-update-timer", 1759763688);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1759763688);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1759763688);
user_pref("app.update.migrated.updateDir3.7615AF439CA8FB5", true);
user_pref("app.update.migrated.updateDir3.769BDC6D18C76F20", true);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "9c6717fe-15bf-4030-972f-3ccb25b8eb99");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1759763657);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{a7f3091c-d7a7-4bbd-9507-3c0b2440d7cb}");
...
user_pref("browser.startup.lastColdStartupCheck", 1760110567);
...
user_pref("captchadetection.lastSubmission", 1759763);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "9d338b08-4773-456d-a926-e959c162b2b2");
user_pref("datareporting.dau.cachedUsageProfileID", "7e06ce28-31e8-4fed-85b3-57af05403acd");
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECJKTWnGx2undBAg0SsmSDFrRjw==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"a2c2e751-9b9f-4206-96ac-8dd7bfe091f4\",\"newtab@mozilla.org\":\"41a4c032-bd79-4bd2-96a8-f1d4f49931d2\",\"pictureinpicture@mozilla.org\":\"99985e4f-025e-48ff-b542-49bd5c67cf17\",\"addons-search-detection@mozilla.com\":\"9f172f9f-508b-4f50-931b-2d67dba8e312\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"default-theme@mozilla.org\":\"5a019b49-f8ae-4b8a-a4a8-202efa70e214\"}");
...
user_pref("nimbus.profileId", "e9324793-16e6-4ec8-9b72-1ee7439eac2d");
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECJ1DbPhCBTbyBAg4eRkhU1wg1g==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.profiles.storeID", "588fa546");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1760110566);
